...
namespace Amc.Shell
{
    internal class MainService : ConsoleServiceBase
    {
        ...
        protected override string Prompt => "amc";
        public override string ServiceName => $"AMC-CLI V{Assembly.GetEntryAssembly().GetName().Version.ToString()}";
        ...
        private bool OnSendCommand(string[] args)
        {
            ...
            if (isSendAll)
            {
                ...
                {
                    tx.Outputs[0].Value -= Bhp.BhpExtensions.Fees.BhpTxFee.EstimateTxFee(tx);
        ...
        */
        ...
        private bool OnInstallCommand(string[] args)
        {
            ...
            Console.WriteLine($"Install successful, please restart amc-cli.");
            return true;
        }
        ...
        private bool OnUnInstallCommand(string[] args)
        {
            ...
            Console.WriteLine($"Uninstall successful, please restart amc-cli.");
            return true;
        }
